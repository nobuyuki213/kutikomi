...
<nav>
	<div class="nav nav-tabs nav-fill mb-3" id="nav-tab" role="tablist">
		...
		<a class="nav-item nav-link {{ empty(Session::get('draft')) ? 'd-none' : ''}} {{ Request::is('places/review/input/draft') ? 'active' : '' }}" href="{{ route('places.draft') }}" role="tab"><small>下書き<br>で探す</small></a>
